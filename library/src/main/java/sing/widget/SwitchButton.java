...
/**
 * app:sb_shadow_effect="true" // 是否启用阴影
 * app:sb_shadow_radius="2dp" // 阴影半径
 * app:sb_shadow_color="#123123" // 阴影颜色
 * app:sb_shadow_offset="5dp" // 阴影向下偏移
 * app:sb_uncheck_color="#FFFFFF" // 关闭颜色
 * app:sb_checked_color="#00FFFF" // 开启颜色
 * app:sb_border_width="1dp" // 边框宽度
 * app:sb_checkline_color="#123123" // 开启指示器颜色
 * app:sb_checkline_width="1dp" // 开启指示器线宽
 * app:sb_uncheckcircle_color="#123123" // 关闭指示器颜色
 * app:sb_uncheckcircle_width="1dp" // 关闭指示器线宽
 * app:sb_uncheckcircle_radius="5dp" // 关闭指示器半径
 * app:sb_checked="true" // 是否选中
 * app:sb_effect_duration="300" // 动画时间，默认300ms
 * app:sb_button_color="#123123" // 按钮颜色
 * app:sb_show_indicator="false" // 是否显示指示器，默认true：显示
 * app:sb_background="#123123" // 背景色，默认白色
 * app:sb_enable_effect="true" // 是否启用特效，默认true
 */
